            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col" id="one">
                        ...
                        <img  src="<?=ROOT?>/assets/images/logo_bg_rm.png" alt="">
                ...
                <div class="footer-col" id="three">
                        ...
                        <div class="social-links">
                            <a href="#https://web.facebook.com/UCSC.LK"><i class="fab fa-facebook-f" style = "line-height:2;" ></i></a>
                            <a href="#"><i class="fab fa-twitter" style = "line-height:2;"></i></a>
                            <a href="#"><i class="fab fa-instagram" style = "line-height:2;"></i></a>
                            <a href="#"><i class="fab fa-linkedin-in" style = "line-height:2;"></i></a>
                        </div>
                <h4>Contact us</h4>
                <ul>

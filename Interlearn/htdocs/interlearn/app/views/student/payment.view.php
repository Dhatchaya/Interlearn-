        ...
        <form class="payment-form" action="#">
          <div class="sub-container">
            ...
            <div class="form-group">
              ...
              <label class="payment-label" for="card-number">Name on payment slip</label>
              <div class="errorSpace1" style="top: 65px"></div>
              <input class="payment-input" type="text" id="name-on-slip" placeholder="   Pavithra H.M.M">
            </div>

            <div class="form-group">
              <label class="payment-label" for="card-holder-name">Address</label>
              <div class="errorSpace2"></div>
              <input class="payment-input" type="text" id="address" placeholder="   ">
            </div>


            <div class="form-group  ">
              <label class="payment-label" for="expiry-month">Course Name</label>
              <div class="errorSpace3"></div>
              <input class="payment-input" type="text" id="address" placeholder="   ">
            </div>
            <div class="form-group  ">
              <label class="payment-label" for="cvv">NIC Number</label>
          ...
          <div class="sub-container">
            <div class="form-group">
              ...
              <label class="payment-label" for="card-number">Payment Date</label>
              <div class="errorSpace1" style="top: 65px"></div>
              <input class="payment-input" type="date" id="card-number">
            </div>

            <div class="form-group">
              <label class="payment-label" for="card-holder-name">Ammount(LKR)</label>
              <div class="errorSpace2"></div>
              <input class="payment-input" type="currency" id="ammount" placeholder=" 5000">
            </div>
            <div class="form-group  ">
              <label class="payment-label" for="cvv">Bank</label>
              <div class="errorSpace4"></div>
            ...
            <div class="form-group div-adject-4 ">
              <label class="payment-label" for="expiry-month">Branch</label>
              <div class="errorSpace3"></div>
              <input class="payment-input" type="text" id="Cheque-No" placeholder=" Colombo">
            </div>
            <div class="form-group div-adject-4 ">
              <label class="payment-label" for="expiry-month">Cheque No. (only if pay on cheque)</label>
              <div class="errorSpace3"></div>
              <input class="payment-input" type="text" id="Cheque-No" placeholder=" 00000000000000">
            </div>

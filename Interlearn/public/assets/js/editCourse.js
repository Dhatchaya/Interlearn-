...
document.getElementById('daysEdit').on('change', function() {
    var teacher_id = document.getElementById('teacher_id').val();
    var day = document.getElementById('daysEdit').val();
    var timeFrom = document.getElementById('timefromEdit').val();
    var timeTo = document.getElementById('timetoEdit').val();
    console.log('hi');
    $.ajax({
      ...
      success: function(response) {
        ...
        document.getElementById('timefromEdit').on('change', function(){
          console.log("here");
          var timeFrom = document.getElementById('timefromEdit').val();
          var timeTo = document.getElementById('timetoEdit').val();
        ...
        document.getElementById('timetoEdit').on('change', function(){
          console.log("here");
          var timeFrom = document.getElementById('timefrom').val();

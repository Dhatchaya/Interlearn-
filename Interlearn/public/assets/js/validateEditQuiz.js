...
const form = document.getElementById("my-form");
  ...
  form.addEventListener("submit", function(event) {
    ...
    var points = document.forms["confirmEditForm"]["quiz_description"].value;
    if (points == "") {
        document.getElementById("descriptions-error").innerHTML = "Please enter the quiz description";
        return false;
    }

    var points = document.forms["confirmEditForm"]["quiz_name"].value;
    if (points == "") {
        document.getElementById("name-error").innerHTML = "Please enter the quiz name";
        return false;
    }

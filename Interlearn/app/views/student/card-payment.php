...
<head>
  ...
  <link rel="stylesheet" href="public/assets/css/navbar-last.css">
  <link rel="stylesheet" href="public/assets/css/student-payment.css">
  <link rel="stylesheet" href="public/assets/css/footer-style.css">
  <link rel="stylesheet" href="public/assets/css/card-payment-style.css">
  <link rel="stylesheet" media="screen and (max-width: 100px)" href="public/assets/css/mobile-nav-bar.css">
...
<body style="background-color: #FFFFFF;">
  <div class="nav-bar">
    <img id="navbar-logo" src="public/assets/images/logo_bg_rm.png" alt="">
    <img class="punchi-logo" src="public/assets/images/punchi- logo.jpeg" alt="">
    ...
    <div class="notification">
      <img class="notifi-dwn" src="public/assets/images/4.png" alt="">
      <img id="dropbtn" class="notifi-up" src="public/assets/images/3.png" alt="">
      <div class="dropdown-content">
    ...
    <div class="profile ">
      <img class="profile-dwn" src="public/assets/images/2.png" alt="">
      <img class="profile-up" src="public/assets/images/1.png" alt="">
    </div>
  ...
  <div class="side-col ">
    ...
    <div class="sidebar-container">
      <div class="edit-profile segment">
        <a href="">
          <img class="edit-img" src="public/assets/images/edit2.png" alt="">
    ...
    <div class="logout ">
      <a href="">
        <img class="edit-img" src="public/assets/images/edit2.png" alt="" id="logout-img">
      ...
      <div class="payment-form-body">
        ...
        <form action="#">
          ...
          <div class="form-group">
            ...
            <img src="public/assets/images/mastercard-logo.png" class="card-type-icon" alt="Mastercard logo">
            <img src="public/assets/images/visa-logo.png" class="card-type-icon" alt="Visa logo">
            <img src="public/assets/images/amex-logo.jpg" class="card-type-icon" alt="American Express logo">
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="footer-col" id="one">
          ...
          <img class="footer-logo" src="public/assets/images/logo_bg_rm.png" alt="">
  ...
  <script src="public/assets/js/card-payment-validation.js"></script>
  <script src="public/assets/js/switching.js"></script>
  <script>
    // *******************************************************************************//

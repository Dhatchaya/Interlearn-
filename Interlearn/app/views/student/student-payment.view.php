...
<body style="background-color: #FFFFFF;">
  ...
  <body style="background-color: #FFFFFF;">
                  ...
                  <div class="payment-form" action="#" method="post"   encType='multipart/form-data'>
                    <div class="sub-container">
                      <div class="form-group">  
                        ...
                        <input name="studentID" class="payment-input" type="text" id="student-id" placeholder="<?= $userid ?>" maxlength="20" >
                      </div>
                      ...
                      <div class="form-group  ">
                        ...
                        <input name="CourseID " class="payment-input" type="text" id="couese-ID" maxlength="5" placeholder="  <?= $courseid ?>">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input name="NameOnSlip " class="payment-input" type="text" id="student-name" placeholder="   Your Name">
                      </div>
                    ...
                    <div class="sub-container ">
                      ...
                      <div class="form-group">
                        ...
                        <input name="Amount" class="payment-input" type="currency" maxlength="5" id="amount" placeholder=" <?= $amount ?>">
                      </div>
    ...
    <script src="<?= ROOT ?>/assets/js/getStudentNameBP.js"></script>

...
<html>
    ...
    <div class="center-body">
            <div class="side-bar">
                <div class="top">    
                    <div class="aboutme">
                        <img src="icons/teacher.png" alt="profile">
                        <span class="user-name">Diana <br/> Fernando</span>
                    </div>
                    <hr>
                </div>
    ...
    <div class="next">
        <footer class="footer">
            <div class="container">
                ...
                <h4>Contact us</h4>
                <ul>
                    <li><a href=><i class="fa fa-map-marker" ></i>  50, stanfford ave, colombo, Sri Lanka</a>  </li>

    ...
    <div class="front">
        ...
        <div class="center-body">
            <div class="side-bar">
                ...
                <div class="bottom">
                   <a href="../Home_Page/index.php"> <i class="material-icons md-32 white">logout</i></a>
                    <span>logout</span>
                </div>
            </div>
            ...
            <div class="center-body-middle">
                <div class="gm">
                    <h2>Good Morning Nisaf !  <i class="material-icons md-32 white">waving_hand</i></h2>
                </div>
                <div class="services">
                    <div class="row1">
                        <a href="#">
                            <div class="task1">
                                ...
                                <div class="task1-heading">
                                    <h3>Vacancies</h3>
                                </div>   
                            </div>
                        </a>
                        
                        <a href="../leave_apply/leaves/index.php">
                            <div class="task1">
                                <div class="task1-image">
                                    <img src="leaves.png" alt="leaves">
                                </div>
